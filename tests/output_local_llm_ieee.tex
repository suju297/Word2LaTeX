...
\titleformat{\section}{\bfseries\fontsize{24.0}{28.8}\selectfont}{\thesection}{0.5em}{}
...
\setlength{\columnsep}{0.012\linewidth}
...
{\fontsize{28.0}{24.0}\selectfont T}
...
{\fontsize{8.0}{9.6}\selectfont TABLE I}

Samples of Times Roman Type Sizes and Styles

\begin{center}
    \includegraphics[width=3.4520833333333334in]{media/image1.png}
    \captionof{figure}{Font Table Scan}
    \label{fig:image1}
\end{center}
...
\begin{center}
    \includegraphics[width=2.9902777777777776in]{media/image2.png}
\end{center}

{\fontsize{8.0}{9.6}\selectfont Fig. 1.  Magnetization as a function of applied field. (Note that “Fig.” is abbreviated and there is a period after the figure number followed by two spaces.)}
...
\addvspace{6.0pt}
\fbox{[Image format .wmf not supported]}where \textit{IF} is the fault current.
\addvspace{6.0pt}
...
{\fontsize{8.0}{9.6}\selectfont Examples:}
...
{\fontsize{8.0}{9.6}\selectfont A technical biography and photograph for each author may be included. The photo should be 2.54 centimeters (1 inch) wide by 3.18 centimeters (1.25 inches) high. The head and shoulders should be centered, and the photo should be flush with the left margin. Please note that biographies and photos are included in the page count.}

{\fontsize{8.0}{9.6}\selectfont The first paragraph should begin with the author’s name (as it appears in the byline) and IEEE membership history. A place and/or date of birth may be included (list place, then date). Next, the author’s educational background is listed. The degrees should be listed with type of degree in what field, which institution, city, state, and country, and year the degree was earned. The author’s major field of study should be lower-cased. }

{\fontsize{8.0}{9.6}\selectfont The second paragraph uses the pronoun of the person (he or she) and not the author’s last name. It lists military and work experience, including summer and fellowship jobs. Job titles are capitalized. The current job must have a location; previous positions may be listed without one. Information concerning previous publications may be included. Try not to list more than three books or published articles. The format for listing publishers of a book within the biography is: title of book (city, state: publisher name, year) similar to a reference. Current and previous research interests end the paragraph.}

{\fontsize{8.0}{9.6}\selectfont The third paragraph begins with the author’s title and last name (e.g., Dr. Smith, Prof. Jones, Mr. Kajor, Ms. Hunter). List any memberships in professional societies other than the IEEE. Finally, list any awards and work for IEEE committees and publications.}

{\fontsize{8.0}{9.6}\selectfont The following is a biography of Nikola Tesla as an example.}

{\fontsize{8.0}{9.6}\selectfont \begin{center}
    \includegraphics[width=1.0in]{media/image4.png}
    \captionof{figure}{Tesla}
    \label{fig:image4}
\end{center}\textbf{Nikola Tesla} (M’1888, F’17) was born in Smiljan in the Austro-Hungarian Empire, on July 9, 1856. He graduated from the Austrian Polytechnic School, Graz, and studied at the University of Prague.}

{\fontsize{8.0}{9.6}\selectfont His employment experience included the American Telephone Company, Budapest, the Edison Machine Works, Westinghouse Electric Company, and Nikola Tesla Laboratories. His special fields of interest included high frequency.}

{\fontsize{8.0}{9.6}\selectfont Dr. Tesla received honorary degrees from institutions of higher learning including Columbia University, Yale University, University of Belgrade, and the University of Zagreb. He received the Elliott Cresson Medal of the Franklin Institute and the Edison Medal of the IEEE. In 1956, the term “tesla” (T) was adopted as the unit of magnetic flux density in the MKSA system. In 1975, the Power Engineering Society established the Nikola Tesla Award in his honor. He died on January 7, 1943.}
